...
Composite task:
- HotDogSetup
- Goal: move hotdog_bun_1 and sausage_1 onto plate_1 on dining_table_1, then place condiment_1 next to plate_1 on dining_table_1.

Initial agent positions:
- agent_0: dining_table_1
- agent_1: dining_table_1
...
Allowed tools and exact symbolic arguments for this task:
{
  ...
  "place_next_to": {
    ...
    "description": "Place an object adjacent to another object on the same surface.",
    "tool_args": [
      "object_id",
      "reference_object_id"
    ]
